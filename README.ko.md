...
[생물학 기반 양방향 로보틱스 연구](reports/neural-link/robotics.ko.html)는 감각·방향·가치·운동 회로 근거를 입력 토큰과 출력 제어에 연결하는 설계를 정리합니다. 호스트 코덱 제어 1,280개 사례와 Mac CPU의 FlyGym/MuJoCo 설치·물리 실행을 검증하고 수정 전 오류 기록도 보존했습니다. 언어모델과 몸을 결합해 새로 학습한 결과는 아닙니다.
